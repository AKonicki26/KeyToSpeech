...
pub const LIBSPEECHD_MINOR_VERSION: u32 = 12;
pub const LIBSPEECHD_MICRO_VERSION: u32 = 1;
...
unsafe extern "C" {
    pub fn spd_fd(connection: *mut SPDConnection) -> ::core::ffi::c_int;
}
unsafe extern "C" {
...
unsafe extern "C" {
    pub fn spd_list_synthesis_voices2(
        connection: *mut SPDConnection,
        language: *const ::core::ffi::c_char,
